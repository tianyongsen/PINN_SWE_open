...
class BasePDE():
    ...
    def __init__(self):
        self.pde = None       # pde funciton
        self.bcs = None       # boundary conditions
        self.geom = None      # geometry
        self.bbox = None
        self.loss_config = []
    ...
    def add_bcs(self, config:list[dict], geom=None):
    ...
    def create_model(self, net):
        ...
        self.data = dde.data.PDE(
            ...
            train_distribution='pseudo'        # use pseudo num,see the sampler.py
        )
...
class BaseTimePDE(BasePDE):
    ...
    def add_bcs(self, config:list[dict]):
